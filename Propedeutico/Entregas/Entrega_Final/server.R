# código original disponible en https://github.com/cameres/gapminder-shiny
# y modificado por SCS para incluir graficos box-plot, estadisticas descriptivas, regresion lineal y analisis de residuos.
